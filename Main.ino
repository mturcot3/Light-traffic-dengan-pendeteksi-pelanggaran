...
int delayMerah = 1000;
int delayMerah2 = 1000;
int delayKuning = 200;
int delayKuning2 = 200;
int delayHijau = 1000;
int delayHijau2 = 1000;
...
//  lcd.begin();   // iInit the LCD for 16 chars 2 lines
  ...
  pinMode(pinLedHijau2, OUTPUT);
   pinMode(lamp, OUTPUT);
  digitalWrite(lamp, LOW);              // kondisi awal supaya relay mati  
  lcd.clear();
  lcd2.clear();
  lcd3.clear();
  lcd4.clear();  
...
void LDR(){
 // put your main code here, to run repeatedly:
  ...
  Blynk.virtualWrite(V9, lamp);    
   if (kecerahan < 70)
  {
    digitalWrite(lamp,HIGH);                              // saat lux dibawah 50 maka lampu akan menyala 
